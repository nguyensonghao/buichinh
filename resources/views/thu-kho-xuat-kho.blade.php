			...
			<form id="form-phe-duyet" method="post" action="{{route('xu-ly-thu-kho-xuat-kho')}}">
				...
				<div class="modal-body">
					...
					<div class="form-group col-md-6">
						...
						<input type="date" class="form-control" name="ngay_thu_kho_xuat_kho" id="ngay_thu_kho_xuat_kho" required>
					</div>
					<div class="form-group col-md-6">
						<label>Thủ kho xuất kho</label>
						<input type="text" class="form-control" name="thu_kho_xuat_kho" id="thu_kho_xuat_kho" required>
					</div>
					<div class="form-group col-md-6">
