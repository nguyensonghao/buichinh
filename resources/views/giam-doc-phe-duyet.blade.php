...
@section('title') Giám đốc phê duyệt @endsection
	...
	<form>
			...
			<table class="table table-bordered table-hover">
				<thead>
					<tr>
						...
						<th class="center">Trưởng phòng vật tư phê duyệt</th>
				...
				<tbody>
					@foreach ($list as $key => $value)
						<tr>
							...
							<td class="center">
								<div class="btn-group">
									<button type="button" class="btn btn-danger btn-sm btn-giam-doc-phe-duyet" data-id="{{$value->phieu_id}}">
										Phê duyệt
									</button>
								</div>
							</td>
		...
		@else
			<div class="alert alert-info">
				<strong>Thông báo!</strong> danh sách phê duyệt trống
			</div>
		@endif
	</form>
</div>
<div class="modal fade" id="modal-phe-duyet">
	<div class="modal-dialog">
		<div class="modal-content">
			<form id="form-phe-duyet" method="post" action="{{route('xu-ly-giam-doc-phe-duyet')}}">
